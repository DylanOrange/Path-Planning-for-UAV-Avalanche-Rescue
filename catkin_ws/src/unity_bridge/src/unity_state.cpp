  ...
  public:
    ...
    void PublishStateStream() {
      ...
      try {
        ...
        // std::cout << "[unity state] position is: " << begin[0] <<" "<<begin[2] <<" "<<begin[1]<<std::endl;
        // std::cout << "[unity state] orientation is: " << -begin[3] <<" "<<-begin[5] <<" "<<-begin[4]<<" "<<begin[6]<<std::endl;
        // std::cout << "[unity state] linear velocity is: " << begin[7] <<" "<<begin[9] <<" "<<begin[8]<<std::endl;
        // std::cout << "[unity state] omega is: " << -begin[10]  <<" "<<-begin[12] <<" "<<-begin[11]<<std::endl;
